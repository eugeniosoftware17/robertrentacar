...
TEXTOS = {
    ...
    'res_campo_email': {'es': 'Correo', 'en': 'Email'},
    ...
    'res_campo_notas': {'es': 'Notas', 'en': 'Notes'},
    'res_campo_opcional': {'es': 'Opcional', 'en': 'Optional'},
    'res_campo_requerido_nota': {'es': '* Campo obligatorio', 'en': '* Required field'},
    'res_seccion_fechas': {'es': 'Fechas de alquiler', 'en': 'Rental dates'},
